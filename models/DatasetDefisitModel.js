...
const DatasetDefisit = db.define('dataset_defisit', {
    nilai: {
        type: DataTypes.JSON,
        allowNull: false,
        get() {
...
Users.hasMany(DatasetDefisit);
DatasetDefisit.belongsTo(Users, {foreignKey: 'userId'})

module.exports = DatasetDefisit